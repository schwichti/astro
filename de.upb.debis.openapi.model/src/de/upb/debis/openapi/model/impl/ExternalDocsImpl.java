...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>External Docs</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.upb.debis.openapi.model.impl.ExternalDocsImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.ExternalDocsImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.ExternalDocsImpl#getVendorExtension <em>Vendor Extension</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalDocsImpl extends MinimalEObjectImpl.Container implements ExternalDocs {
	/**
	...
	public EList<VendorExtension> getVendorExtension() {
		if (vendorExtension == null) {
			vendorExtension = new EObjectContainmentEList<VendorExtension>(VendorExtension.class, this, OpenapiPackage.EXTERNAL_DOCS__VENDOR_EXTENSION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OpenapiPackage.EXTERNAL_DOCS__VENDOR_EXTENSION:
