 ...
 * </p>
 * <ul>
 *   <li>{@link de.upb.debis.openapi.model.impl.SwaggerImpl#getSwagger <em>Swagger</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.SwaggerImpl#getInfo <em>Info</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.SwaggerImpl#getHost <em>Host</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.SwaggerImpl#getBasePath <em>Base Path</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.SwaggerImpl#getPaths <em>Paths</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.SwaggerImpl#getDefinitions <em>Definitions</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.SwaggerImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.SwaggerImpl#getResponses <em>Responses</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.SwaggerImpl#getSecurityDefinitions <em>Security Definitions</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.SwaggerImpl#getExternalDocs <em>External Docs</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.SwaggerImpl#getVendorExtension <em>Vendor Extension</em>}</li>
 * </ul>
 *
 * @generated
 */
