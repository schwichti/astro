 ...
 * </p>
 * <ul>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getPatternProperty <em>Pattern Property</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getGet <em>Get</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getPut <em>Put</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getPost <em>Post</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getDelete <em>Delete</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getHead <em>Head</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getPatch <em>Patch</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getBodyParameter <em>Body Parameter</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getHeaderParameterSubSchema <em>Header Parameter Sub Schema</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getFormDataParameterSubSchema <em>Form Data Parameter Sub Schema</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getQueryParameterSubSchema <em>Query Parameter Sub Schema</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getPathParameterSubSchema <em>Path Parameter Sub Schema</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getJsonReference <em>Json Reference</em>}</li>
 *   <li>{@link de.upb.debis.openapi.model.impl.PathItemImpl#getVendorExtension <em>Vendor Extension</em>}</li>
 * </ul>
 *
 * @generated
 */
