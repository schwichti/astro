...
public class FileWriter {
	...
	public def write(String filename, String contents, boolean append){
		
		try {
			val char_output = new OutputStreamWriter(
				     new FileOutputStream(this.getAbsoluteFilename(filename), append),
