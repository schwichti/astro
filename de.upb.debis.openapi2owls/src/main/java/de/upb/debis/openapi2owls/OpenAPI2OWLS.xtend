	...
	private def String handleParameter(Operation op, String httpmethod, String host, String parametername, String parametertype, String parameterformat, String parameterdescription){
		...
		'''
							...
							«IF alignment.containsKey(input_uri) && alignment.get(input_uri)!==null»
								<process:parameterType rdf:datatype="http://www.w3.org/2001/XMLSchema#anyURI">«alignment.get(input_uri).subject.URI.replace("http://schema.org/", "http://127.0.0.1/ontology/schema.owl#")»</process:parameterType>
							«ELSE»
							...
							«IF op.responses!==null»
								«FOR ResponseValue responveValue : op.responses.responseValue»
									...
									«IF alignment.containsKey(output_uri) && alignment.get(output_uri)!==null»
										<process:parameterType rdf:datatype="http://www.w3.org/2001/XMLSchema#anyURI">«alignment.get(output_uri).subject.URI.replace("http://schema.org/", "http://127.0.0.1/ontology/schema.owl#")»</process:parameterType>
									«ELSE»
