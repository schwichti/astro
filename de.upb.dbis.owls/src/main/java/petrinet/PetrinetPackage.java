...
public interface PetrinetPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link petrinet.Identifyable <em>Identifyable</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see petrinet.Identifyable
	 * @see petrinet.impl.PetrinetPackageImpl#getIdentifyable()
	 * @generated
	 */
	int IDENTIFYABLE = 5;
	 ...
	 * @ordered
	 */
	int IDENTIFYABLE__ID = 0;

	/**
	 * The number of structural features of the '<em>Identifyable</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int IDENTIFYABLE_FEATURE_COUNT = 1;

	/**
	 * The number of operations of the '<em>Identifyable</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int IDENTIFYABLE_OPERATION_COUNT = 0;
	 ...
	 * @ordered
	 */
	int NODE_FEATURE_COUNT = IDENTIFYABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int NODE_OPERATION_COUNT = IDENTIFYABLE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ARC__SOURCE = IDENTIFYABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ARC__TARGET = IDENTIFYABLE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ARC_FEATURE_COUNT = IDENTIFYABLE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int ARC_OPERATION_COUNT = IDENTIFYABLE_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link petrinet.Identifyable <em>Identifyable</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Identifyable</em>'.
	 * @see petrinet.Identifyable
	 * @generated
	 */
	EClass getIdentifyable();

	/**
	 * Returns the meta object for the attribute '{@link petrinet.Identifyable#getId <em>Id</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Id</em>'.
	 * @see petrinet.Identifyable#getId()
	 * @see #getIdentifyable()
	 * @generated
	 */
	EAttribute getIdentifyable_Id();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link petrinet.Identifyable <em>Identifyable</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see petrinet.Identifyable
		 * @see petrinet.impl.PetrinetPackageImpl#getIdentifyable()
		 * @generated
		 */
		EClass IDENTIFYABLE = eINSTANCE.getIdentifyable();
		 ...
		 * @generated
		 */
		EAttribute IDENTIFYABLE__ID = eINSTANCE.getIdentifyable_Id();
