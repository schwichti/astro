...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	...
	/**
	 * 
	 * @see https://wiki.eclipse.org/EMF/FAQ#How_can_I_ensure_that_an_xsi:schemaLocation_is_serialized_for_my_packages.3F
	 * @generated NOT
	 */
	@Override
	protected Resource createResource(String uri)
	{
	  return super.createResource("PetriNet.ecore");
	}
	 ...
	 * @generated
	 */
	private EClass identifyableEClass = null;
	 ...
	 * @generated
	 */
	public EClass getIdentifyable() {
		return identifyableEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getIdentifyable_Id() {
		return (EAttribute)identifyableEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		identifyableEClass = createEClass(IDENTIFYABLE);
		createEAttribute(identifyableEClass, IDENTIFYABLE__ID);
	}
	...
	public void initializePackageContents() {
		...
		nodeEClass.getESuperTypes().add(this.getIdentifyable());
		arcEClass.getESuperTypes().add(this.getIdentifyable());
		...
		initEReference(getPetriNet_Places(), this.getNode(), null, "places", null, 0, -1, PetriNet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(identifyableEClass, Identifyable.class, "Identifyable", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getIdentifyable_Id(), ecorePackage.getEString(), "id", null, 0, 1, Identifyable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
