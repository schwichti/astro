...
public class PetrinetAdapterFactory extends AdapterFactoryImpl {
	...
	protected PetrinetSwitch<Adapter> modelSwitch =
		new PetrinetSwitch<Adapter>() {
			...
			@Override
			public Adapter caseIdentifyable(Identifyable object) {
				return createIdentifyableAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link petrinet.Identifyable <em>Identifyable</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see petrinet.Identifyable
	 * @generated
	 */
	public Adapter createIdentifyableAdapter() {
		return null;
	}
