...
public class PetrinetSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PetrinetPackage.NODE: {
				...
				if (result == null) result = caseIdentifyable(node);
			...
			case PetrinetPackage.ARC: {
				...
				if (result == null) result = caseIdentifyable(arc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PetrinetPackage.PLACE: {
				...
				if (result == null) result = caseIdentifyable(place);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetPackage.TRANSITION: {
				...
				if (result == null) result = caseIdentifyable(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetPackage.IDENTIFYABLE: {
				Identifyable identifyable = (Identifyable)theEObject;
				T result = caseIdentifyable(identifyable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Identifyable</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Identifyable</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIdentifyable(Identifyable object) {
		return null;
	}
