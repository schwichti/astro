 ...
 * </p>
 * <ul>
 *   <li>{@link de.upb.dbis.openapi.model.impl.OperationImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.OperationImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.OperationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.OperationImpl#getExternalDocs <em>External Docs</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.OperationImpl#getOperationId <em>Operation Id</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.OperationImpl#getBodyParameter <em>Body Parameter</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.OperationImpl#getHeaderParameterSubSchema <em>Header Parameter Sub Schema</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.OperationImpl#getFormDataParameterSubSchema <em>Form Data Parameter Sub Schema</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.OperationImpl#getQueryParameterSubSchema <em>Query Parameter Sub Schema</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.OperationImpl#getPathParameterSubSchema <em>Path Parameter Sub Schema</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.OperationImpl#getJsonReference <em>Json Reference</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.OperationImpl#getResponses <em>Responses</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.OperationImpl#isDeprecated <em>Deprecated</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.OperationImpl#getVendorExtension <em>Vendor Extension</em>}</li>
 * </ul>
 *
 * @generated
 */
