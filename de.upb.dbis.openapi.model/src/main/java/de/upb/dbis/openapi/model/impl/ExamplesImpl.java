 ...
 * </p>
 * <ul>
 *   <li>{@link de.upb.dbis.openapi.model.impl.ExamplesImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExamplesImpl extends MinimalEObjectImpl.Container implements Examples {
	...
	protected EClass eStaticClass() {
		return OpenapiPackage.Literals.EXAMPLES;
	}
	...
	public void setBody(String newBody) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OpenapiPackage.EXAMPLES__BODY, oldBody, body));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OpenapiPackage.EXAMPLES__BODY:
				return getBody();
		}
