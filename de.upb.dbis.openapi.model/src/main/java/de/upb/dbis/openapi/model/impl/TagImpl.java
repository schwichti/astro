 ...
 * </p>
 * <ul>
 *   <li>{@link de.upb.dbis.openapi.model.impl.TagImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.TagImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.TagImpl#getExternalDocs <em>External Docs</em>}</li>
 *   <li>{@link de.upb.dbis.openapi.model.impl.TagImpl#getVendorExtension <em>Vendor Extension</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TagImpl extends MinimalEObjectImpl.Container implements Tag {
	...
	public EList<VendorExtension> getVendorExtension() {
		if (vendorExtension == null) {
			vendorExtension = new EObjectContainmentEList<VendorExtension>(VendorExtension.class, this, OpenapiPackage.TAG__VENDOR_EXTENSION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case OpenapiPackage.TAG__VENDOR_EXTENSION:
